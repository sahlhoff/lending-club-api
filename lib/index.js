...
var LendingClub = function(options){
	...
	this.account.transfer.add = function(callback){
		var url = self.baseURI + '';
	};

	this.account.transfer.withdraw = function(callback){
		var url = self.baseURI + '';
	};
	...
	this.account.cancelTransfers = function(callback){
		var url = self.baseURI + '';
	};
	...
	this.account.portfolioOwned = function(callback){
		var url = self.baseURI + '';
	};

	this.account.createPortfolio = function(callback){
		var url = self.baseURI + '';
	};

	this.account.submitOrder = function(callback){
		var url = self.baseURI + '';
	};
